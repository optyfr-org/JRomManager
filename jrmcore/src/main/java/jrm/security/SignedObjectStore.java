 ...
 * </ol>
 * <p>
 * Bare unsigned Java object streams ({@code 0xACED}) are rejected. Existing unsigned caches must be
 * regenerated by a normal load/save cycle so they are rewritten in the signed format.
 * </p>
 */
public final class SignedObjectStore {
    ...
    public static Object readBytes(final Session session, final byte[] fileBytes, final DeserializationFilter.Mode mode,
        ...
        // Reject bare unsigned Java serialization streams (STREAM_MAGIC 0xACED). Attackers who can
        // write workspace files must not trigger ObjectInputStream.readObject() without integrity.
